...
|---|---|---|
| `tx_esp32_lifi_dual_mode.ino` | TX ESP32 | 4B5B encoding, NRZ/OOK output, chunk carousel, USB serial preloading |
| `rx_esp32_lifi_dual_mode.ino` | RX ESP32 | 4B5B decoding, CRC validation, chunk assembly, Vref PWM commands |
...
Original firmware: `../../vlc/firmware/` (read-only, do not modify)